	...
	return e.oProtocolInc.getNetworkBond(e,{
		async:!1,success:function(n){
			"true"==s.$XML(n).find("enabled").eq(0).text()?t.push({
				ipv4:s.$XML(n).find("ipAddress").eq(0).text(),ipv6:s.$XML(n).find("ipv6Address").eq(0).text()
			}
			):e.oProtocolInc.getNetworkInterface(e,{
				async:!1,success:function(e){
					for(var n=s.$XML(e).find("NetworkInterface",!0),r=0,o=n.length;o>r;r++){
						t.push({
							ipv4:s.$XML(e).find("ipAddress").eq(0).text(),ipv6:s.$XML(e).find("ipv6Address").eq(0).text()
						}
						);
						break
					}
...
var Y=function(e,t,s,n,r,o,i){
	var a={
		protocol:t,success:null,error:null
	};
...
,this.I_StartRealPlay=function(e,t){
	var n=this.findDeviceIndexByIP(e),r=-1,o="",i="",a=-1,c=0,d=0,P=!1,h={
		iWndIndex:u,iStreamType:1,iChannelID:1,bZeroChannel:!1
	};
	if(I.extend(h,t),-1!=n){
		j(l[n]);
		...
		if(I.extend(h,{
			urlProtocol:i,cgi:o,iPort:a,iStreamType:d,iChannelID:c
		}
...
,this.I_PTZControl=function(e,t,s){
	var n={
		iWndIndex:u,iPTZIndex:e,iPTZSpeed:4
	};
...
,this.I_RecordSearch=function(e,t,s,n,r){
	...
	if(-1!=o){
		var i=l[o],a={
			iChannelID:t,szStartTime:s,szEndTime:n,iSearchPos:0,success:null,error:null
		};
		I.extend(a,r),i.oProtocolInc.recordSearch(i,a)
	}
}
,this.I_StartPlayback=function(e,t){
	var n=this.findDeviceIndexByIP(e),r=-1,o="",i="",a=-1,c=1,p=I.dateFormat(new Date,"yyyy-MM-dd"),d={
		iWndIndex:u,iChannelID:1,szStartTime:p+" 00:00:00",szEndTime:p+" 23:59:59"
	};
	if(I.extend(d,t),-1!=n){
		j(l[n]);
		...
		I.extend(d,{
			urlProtocol:i,cgi:o,iPort:a,iChannelID:c
		}
...
,this.I_ReversePlayback=function(e,t){
	var n=this.findDeviceIndexByIP(e),r=-1,o="",i="",a=-1,c=-1,p=I.dateFormat(new Date,"yyyy-MM-dd"),d={
		iWndIndex:u,iChannelID:1,bZeroChannel:!1,szStartTime:p+" 00:00:00",szEndTime:p+" 23:59:59"
	};
	if(I.extend(d,t),-1!=n){
		j(l[n]);
		var P=l[n],h=parseInt(s.$XML(m).find("ProtocolType").eq(0).text(),10);
...
,this.I_Restart=function(e,t){
	var s=this.findDeviceIndexByIP(e),n={
		success:null,error:null
	};
	if(I.extend(n,t),-1!=s){
		var r=l[s];
...
,this.I_RemoteConfig=function(e,t){
	var s=this.findDeviceIndexByIP(e),n=-1,r=-1,o={
	...
	if(I.extend(o,t),-1!=s){
		...
		if(":"==I.Base64.decode(i.szAuth)[0])var a=I.Base64.decode(i.szAuth).split(":")[1],u=I.Base64.decode(i.szAuth).split(":")[2];
		else var a=I.Base64.decode(i.szAuth).split(":")[0],u=I.Base64.decode(i.szAuth).split(":")[1];
...
,et.prototype.submitRequest=function(){
	...
	if(this.options.async){
		...
		-1!=s&&(t={
			iRequestID:s,funSuccessCallback:this.options.success,funErrorCallback:this.options.error
		}
...
tt.prototype.CGI={
	login:"%s%s:%s/ISAPI/Security/userCheck",getAudioInfo:"%s%s:%s/ISAPI/System/TwoWayAudio/channels",getDeviceInfo:"%s%s:%s/ISAPI/System/deviceInfo",getAnalogChannelInfo:"%s%s:%s/ISAPI/System/Video/inputs/channels",getDigitalChannelInfo:"%s%s:%s/ISAPI/ContentMgmt/InputProxy/channels/status",getZeroChannelInfo:"%s%s:%s/ISAPI/ContentMgmt/ZeroVideo/channels",getStreamChannels:{
	...
	,set3DZoom:"%s%s:%s/ISAPI/PTZCtrl/channels/%s/position3D",SDKCapabilities:"%s%s:%s/SDK/capabilities"
}
,tt.prototype.login=function(e,t,n,r){
	var o=2==r.protocol?"https://":"http://",i=k(this.CGI.login,o,e,t),a=new et,c={
		type:"GET",url:i,auth:n,success:null,error:null
	};
...
,tt.prototype.getAudioInfo=function(e,t){
	var s=k(this.CGI.getAudioInfo,e.szHttpProtocol,e.szIP,e.iCGIPort),n=new et,r={
		type:"GET",url:s,auth:e.szAuth,success:null,error:null
	};
...
,tt.prototype.getDeviceInfo=function(e,t){
	var n=k(this.CGI.getDeviceInfo,e.szHttpProtocol,e.szIP,e.iCGIPort),r=new et,o={
		type:"GET",url:n,auth:e.szAuth,success:null,error:null
	};
...
,tt.prototype.getDigitalChannelInfo=function(e,t){
	var n=k(this.CGI.getDigitalChannelInfo,e.szHttpProtocol,e.szIP,e.iCGIPort),r=new et,o={
		type:"GET",url:n,auth:e.szAuth,success:null,error:null
	};
	I.extend(o,t),I.extend(o,{
		success:function(e){
...
,tt.prototype.ptzAutoControl=function(e,t,s,n){
	...
	var c=new et,u={
		type:"PUT",url:o,async:!1,auth:e.szAuth,data:i,success:null,error:null
	}
	,l=this;
...
,tt.prototype.ptzControl=function(e,t,s,n){
	...
	switch(n.iPTZIndex){
		case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:c=this.CGI.ptzControl,a="<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>"+i[n.iPTZIndex].pan+"</pan><tilt>"+i[n.iPTZIndex].tilt+"</tilt></PTZData>";
		break;
		case 10:case 11:c=this.CGI.ptzControl,a="<?xml version='1.0' encoding='UTF-8'?><PTZData><zoom>"+i[n.iPTZIndex].speed+"</zoom></PTZData>";
		break;
		case 12:case 13:c=this.CGI.ptzFocus,a="<?xml version='1.0' encoding='UTF-8'?><FocusData><focus>"+i[n.iPTZIndex].speed+"</focus></FocusData>";
		break;
		case 14:case 15:c=this.CGI.ptzIris,a="<?xml version='1.0' encoding='UTF-8'?><IrisData><iris>"+i[n.iPTZIndex].speed+"</iris></IrisData>";
		break;
		default:return void(W(n.error)&&n.error())
	}
...
,tt.prototype.setPreset=function(e,t,s){
	...
	var i=new et,a={
		type:"PUT",url:r,auth:e.szAuth,data:o,success:null,error:null
	};
...
,tt.prototype.recordSearch=function(e,n){
	...
	var u=new et,l={
		type:"POST",url:r,auth:e.szAuth,data:o,success:null,error:null
	};
	I.extend(l,n),I.extend(l,{
		success:function(e){
			var t=[];
...
,tt.prototype.restart=function(e,t){
	var s=k(this.CGI.restart,e.szHttpProtocol,e.szIP,e.iCGIPort),n=new et,r={
		type:"PUT",url:s,auth:e.szAuth,success:null,error:null
	};
	I.extend(r,t),I.extend(r,{
		success:function(e){
			t.success&&t.success(e)
...
,tt.prototype.restore=function(e,t,s){
	var n=k(this.CGI.restore,e.szHttpProtocol,e.szIP,e.iCGIPort,t),r=new et,o={
		type:"PUT",url:n,auth:e.szAuth,success:null,error:null
	};
...
,tt.prototype.set3DZoom=function(e,t,n,r){
	...
	var a=I.loadXML(n),c=parseInt(s.$XML(a).find("StartPoint").eq(0).find("positionX").eq(0).text(),10),u=parseInt(s.$XML(a).find("StartPoint").eq(0).find("positionY").eq(0).text(),10),l=parseInt(s.$XML(a).find("EndPoint").eq(0).find("positionX").eq(0).text(),10),p=parseInt(s.$XML(a).find("EndPoint").eq(0).find("positionY").eq(0).text(),10),d="<?xml version='1.0' encoding='UTF-8'?><position3D><StartPoint><positionX>"+c+"</positionX><positionY>"+(255-u)+"</positionY></StartPoint><EndPoint><positionX>"+l+"</positionX><positionY>"+(255-p)+"</positionY></EndPoint></position3D>",P=new et,h={
		type:"PUT",url:i,data:d,auth:e.szAuth,success:null,error:null
	};
...
st.prototype.CGI={
	login:"%s%s:%s/PSIA/Custom/SelfExt/userCheck",getAudioInfo:"%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels",getDeviceInfo:"%s%s:%s/PSIA/System/deviceInfo",getAnalogChannelInfo:"%s%s:%s/PSIA/System/Video/inputs/channels",getDigitalChannelInfo:"%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynVideo/inputs/channels/status",getZeroChannelInfo:"%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/ZeroVideo/channels",getStreamChannels:{
...
,st.prototype.ptzControl=function(e,t,s,n){
	...
	switch(n.iPTZIndex){
		case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:a=this.CGI.ptzControl,i="<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>"+o[n.iPTZIndex].pan+"</pan><tilt>"+o[n.iPTZIndex].tilt+"</tilt></PTZData>";
		break;
		case 10:case 11:a=this.CGI.ptzControl,i="<?xml version='1.0' encoding='UTF-8'?><PTZData><zoom>"+o[n.iPTZIndex].speed+"</zoom></PTZData>";
		break;
		case 12:case 13:a=this.CGI.ptzFocus,i="<?xml version='1.0' encoding='UTF-8'?><FocusData><focus>"+o[n.iPTZIndex].speed+"</focus></FocusData>";
		break;
		case 14:case 15:a=this.CGI.ptzIris,i="<?xml version='1.0' encoding='UTF-8'?><IrisData><iris>"+o[n.iPTZIndex].speed+"</iris></IrisData>";
		break;
		default:return void(W(n.error)&&n.error())
	}
	r=k(a,e.szHttpProtocol,e.szIP,e.iCGIPort,s.iChannelID);
	var c=new et,u={
		type:"PUT",url:r,async:!1,auth:e.szAuth,data:i,success:null,error:null
	};
	I.extend(u,n),I.extend(u,{
		success:function(e){
			n.success&&n.success(e)
...
,st.prototype.setPreset=function(e,t,s){
	...
	var o=new et,i={
		type:"PUT",url:n,auth:e.szAuth,data:r,success:null,error:null
	};
	I.extend(i,s),I.extend(i,{
		success:function(e){
			s.success&&s.success(e)
...
,st.prototype.set3DZoom=function(e,t,s,n){
	var r=k(this.CGI.set3DZoom,e.szHttpProtocol,e.szIP,e.iCGIPort,t.iChannelID),o=new et,i={
		type:"PUT",url:r,data:s,auth:e.szAuth,success:null,error:null
	};
...
rt.prototype.extend=function(){
	...
	,s=1,n=arguments.length;
	n>s;
	s++)if(null!=(e=arguments[s]))for(var r in e){
		var o=(t[r],e[r]);
...
,rt.prototype.browser=function(){
	var e=/(webkit)[ \/]([\w.]+)/,t=/(opera)(?:.*version)?[ \/]([\w.]+)/,s=/(msie) ([\w.]+)/,n=/(trident.*rv:)([\w.]+)/,r=/(mozilla)(?:.*? rv:([\w.]+))?/,o=navigator.userAgent.toLowerCase(),i=e.exec(o)||t.exec(o)||s.exec(o)||n.exec(o)||o.indexOf("compatible")<0&&r.exec(o)||["unknow","0"];
...
,rt.prototype.dateFormat=function(e,t){
	...
	for(var n in s)new RegExp("("+n+")").test(t)&&(t=t.replace(RegExp.$1,1==RegExp.$1.length?s[n]:("00"+s[n]).substr((""+s[n]).length)));return t
}
,rt.prototype.Base64={
